...
fn get_timezone_coordinates(tz: &Tz) -> Result<(f64, f64)> {
    ...
    let coords = match tz_str.as_str() {
        ...
        "America/Montreal" | "America/Toronto" => (40.7128, -74.0060), // NYC
        ...
        "America/North_Dakota/New_Salem" | "America/Winnipeg" => (41.8781, -87.6298), // Chicago
        ...
        _ => {
            Log::log_indented(&format!("Unknown timezone '{}', using UTC fallback", tz_str));
